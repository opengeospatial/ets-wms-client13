...
<ctl:package
  ...
  <ctl:test name="main:wms-client">
    ...
    <xsl:variable name="wms-url" >
     <xsl:choose>
       <xsl:when test="doc-available('https://cite.deegree.org/deegree-webservices-3.5.6/services/wms130?service=WMS&amp;version=1.3.0&amp;request=GetCapabilities')">
         <xsl:value-of select="'https://cite.deegree.org/deegree-webservices-3.5.6/services/wms130?service=WMS&amp;version=1.3.0&amp;request=GetCapabilities'"/>
       </xsl:when>
