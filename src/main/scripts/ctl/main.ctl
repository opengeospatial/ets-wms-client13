        ...
        <xsl:when test="string-length($monitor-urls/wms:GetCapabilities) gt 0 and string-length($monitor-urls/wms:GetMap) gt 0">
          <ctl:form method="POST" width="800" height="600" xmlns="http://www.w3.org/1999/xhtml">
            ...
            <p style="margin-top: 0px;margin-bottom: 0px;">
              <b>NOTE:</b>  After clicking the 'Stop testing' button the proxy endpoint "<xsl:value-of select="$monitor-urls/wms:GetCapabilities"/>" will not be available any more.</p>
            <br/>
